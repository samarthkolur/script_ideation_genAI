...
export function ConstraintForm() {
  ...
  if (isError || !taxonomy) {
    return (
      <EmptyState
        tone="destructive"
        description="Couldn't load the constraint taxonomy. Check the API/database connection and try again."
      />
    );
  }
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-6">
      <StaggerContainer className="flex flex-col gap-6">
        ...
        <StaggerItem>
          <Card>
            ...
            <CardContent className="flex flex-col gap-6">
              <div className="flex flex-col gap-3">
                ...
                <div className="grid grid-cols-2 gap-2 sm:grid-cols-3">
                  {genreOptions.map((g) => (
                    <label
                      key={g.code}
                      className="flex cursor-pointer items-center gap-2 rounded-md border border-border px-3 py-2.5 text-sm transition-colors duration-150 has-[[data-state=checked]]:border-foreground has-[[data-state=checked]]:bg-accent"
                    >
              ...
              <FormField label="Target audience" htmlFor="audience" className="sm:w-72">
            ...
            <CardContent className="flex flex-col gap-6">
              <RadioGroup value={budgetTier} onValueChange={setBudgetTier} className="grid grid-cols-2 gap-3 sm:grid-cols-4">
                {budgetOptions.map((b) => (
                  <label
                    key={b.code}
                    className="flex cursor-pointer items-start gap-2 rounded-md border border-border p-3 text-sm transition-colors duration-150 has-[[data-state=checked]]:border-foreground has-[[data-state=checked]]:bg-accent"
                  >
        ...
        <StaggerItem>
          <Card>
            ...
            <CardContent className="grid gap-6 sm:grid-cols-2">
              ...
              <FormField label="Censorship framework" htmlFor="framework">
                <Select
                  value={framework}
              ...
              <FormField label="Target rating" htmlFor="rating">
        ...
        <StaggerItem>
          <Card>
            ...
            <CardContent className="grid gap-6 sm:grid-cols-3">
              <FormField label="Location type" htmlFor="location">
              ...
              <FormField label="Cast size" htmlFor="cast">
              ...
              <FormField label="VFX dependency" htmlFor="vfx">
        ...
        <StaggerItem>
          <div className="surface-raised flex flex-col gap-3 rounded-xl p-4 sm:flex-row sm:items-center sm:justify-between">
