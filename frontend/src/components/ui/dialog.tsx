...
function DialogFooter({
  ...
  return (
    <div
      ...
      className={cn(
        "-mx-5 -mb-5 flex flex-col-reverse gap-2 rounded-b-lg border-t border-border p-5 sm:flex-row sm:justify-end",
        className
      )}
      {...props}
    >
